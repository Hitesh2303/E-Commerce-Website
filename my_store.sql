...
INSERT INTO `brands` (`brand_id`, `brand_title`, `categories_title`, `product_price`, `quantity`) VALUES
(7, 'dell', 'mouse', 1000, 5);
...
INSERT INTO `categories` (`category_id`, `brand_title`, `category_title`, `product_price`, `quantity`) VALUES
(1, 0, 'mouse', 0, 0),
(2, 0, 'keyboard ', 0, 0);
